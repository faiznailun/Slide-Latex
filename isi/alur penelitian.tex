...
\onslide<4-> \node (4) [kotak, right of=3, xshift=+2.5cm] {Hitung jarak titik ke \textit{centroid}};
\onslide<5-> \node (5) [kotak, above of=4, yshift=+2.6cm] {Pengelompokan berdasarkan jarak terkecil};
...
\onslide <8-> \node (opt) [belahketupat, below of=mut, yshift=-2.2cm] {Populasi sama?};
